...
return [
    ...
    */
    ...
    // Confirmation cancel messages and bubbles
    'close'                                       => 'close',
    'cancel_confirm'                              => 'Are you sure you want to cancel this item?',
    'cancel_confirmation_title'                   => 'Item Canceled',
    'cancel_confirmation_message'                 => 'The item has been canceled successfully.',
    'cancel_confirmation_not_title'               => 'NOT canceled',
    'cancel_confirmation_not_message'             => "There's been an error. Your item might not have been canceled.",
    'cancel_confirmation_not_canceled_title'       => 'Not canceled',
    'cancel_confirmation_not_canceled_message'     => 'Nothing happened. Your item is safe.',

    // Confirmation new request messages and bubbles
    'create' => 'Create',
    'confirmation' => 'Confirmation',
    'request_confirm'                              => 'Are you sure you want to create a new request?',
    'request_confirmation_not_title'               => 'NOT created',
    'request_confirmation_not_message'             => "There's been an error. Your item might not have been created.",

    // Confirmation upload SAP messages and bubbles
    'upload' => 'Upload',
    'upload_confirmation_message'                 => 'The item(s) has been uploaded successfully.',
    'upload_confirmation_empty_message'           => 'No item to upload to SAP.',
    'upload_confirm'                              => 'Are you sure you want to upload the item(s) to SAP?',
    'upload_confirmation_not_title'               => 'NOT uploaded',
    'upload_confirmation_not_message'             => "There's been an error. Your item(s) might not have been uploaded.",
    ...
    'create_success' => 'The item has been created successfully.',
