...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <img src="{{asset('images/logo-taisho.png')}}" style="width: 100px;height:auto" class="mb-3 d-block mx-auto">
            <div class="card">
                <div class="card-body">
                    <p class="text-center font-weight-bold">Login {{config('app.name')}}</p>
