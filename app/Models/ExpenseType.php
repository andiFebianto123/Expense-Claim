...
class ExpenseType extends Model
{
    ...
    protected $fillable = ['expense_id', 'level_id', 'limit', 'limit_daily', 'expense_code_id', 'is_bod', 'is_traf', 'is_bp_approval', 'bod_level', 'limit_business_approval', 'currency','limit_monthly', 'remark'];
